...
def main():
    ...
    PACKAGE_DIR = str(Path(__file__).resolve().parent) # (folder ".../latex2anki" in which this script resides)
    ...
    subprocess.run(["plastex", "--extra-templates=" + PACKAGE_DIR, "--filename=" + HTML_FILENAME, INPUT_FILE])
